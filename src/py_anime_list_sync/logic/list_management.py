...
def get_list_for(account: AuthenticatedAccount, sort: str, status: str, limit: int):
    """
    ...
    if account.tracker == AVAILABLE_TRACKERS[0]:
        ...
        anime_list_with_data = mal_get_anime_list_data(account, anime_list)
        print_mal_table(anime_list_with_data)
